...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('main', '0002_tags_answers_answer_text_answers_is_deleted_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='question',
            name='author',
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.PROTECT, related_name='questions_written', to='main.users'),
        ),
    ]
