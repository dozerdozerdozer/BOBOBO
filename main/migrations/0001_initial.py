# Generated by Django 4.2.6 on 2023-11-15 10:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nickname', models.CharField(default='durachyo', max_length=50, verbose_name='User Nickname')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='questions_written', to='main.users')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('answer_text', models.TextField(default='я дурак', max_length=1000)),
                ('likes_amount', models.PositiveIntegerField(default=0)),
                ('truly', models.BooleanField(default=False)),
                ('is_deleted', models.BooleanField(default=False)),
                ('is_correct', models.BooleanField(default=False)),
                ('author', models.ForeignKey(default='', on_delete=django.db.models.deletion.PROTECT, to='main.users')),
